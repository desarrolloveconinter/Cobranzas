<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ctrlDistCampanas.aspx.cs" Inherits="Cobranzas.Emergentes.ctrlDistCampanas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="ctrlDistCampanas.aspx.js?ver=3" type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(Inicializar);
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <h2><asp:Literal ID="Literal23" runat="server" Text="<%$ Resources:Recursos, AutomaticDistributionOfAccountsToCampaign %>"></asp:Literal></h2>
    <div id="tabs">
        <ul>
        ...
        <div id="tabDetalles">
            ...
            <table class="TablaDatos">
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" id="txtNombre" /><br /><input type="checkbox" id="chkExcluir" /><asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:Recursos, ExcludeOtherCampaignsToAssignToThis%>"></asp:Literal>.
                    </td>
                </tr>
                <tr>
                    <th>
                    ...
                    <th>
                        <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Recursos, Campaign%>"></asp:Literal>:
                    </th>
                    <td>
